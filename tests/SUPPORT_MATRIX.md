...
- `test_knowledge_graph_quality_ratchet.py` — Phase 3.8 knowledge graph quality ratchet
...
- `test_ollama_client_quality_ratchet.py` — Phase 3.8 Ollama client quality ratchet
...
- `test_streaming_quality_ratchet.py` — Phase 3.8 streaming quality ratchet
...
- Use `docs/testing/coverage.md` for the Phase 3.6 baseline floor, the Phase 3.7 Priority 1 ratchet, and the committed Phase 3.8 Priority 2 ratchet results.
